...
function ChatInput({chatId}:Props) {
    ...
    const sendMessage= async ( e: FormEvent<HTMLFormElement>)=>{
        ...
        const message: Message = {
            ...
            user: {
                ...
                avatar: session?.user?.image! || `https://avatars.dicebear.com/api/human/${session?.user?.email!}.svg`,
    ...
    //toast notification to say am thinking
const notification= toast.loading('Hmmm...🤔 i am thinking...')
    ...
    await fetch('/api/askQuestion', {
        ...
        //Toast notification to say am done
        toast.success('Done!👍 niko chojo and stuff', {
            id: notification,
            });
  ...
  return (
    <div className="bg-gray-700/50 text-gray-400 rounded-lg text-sm ">
        <form className="p-5 space-x-5 flex" onSubmit={sendMessage}>
            ...
            type="text"
             placeholder="Type your crazy questions here ..."/>
            <button 
